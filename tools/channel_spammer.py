...
class PowerfulChannelCreatorAndSpammer:
    def __init__(self):
        self.banner = r"""
 ________  ________  ________  _____ ______   _____ ______   _______   ________     
|\   ____\|\   __  \|\   __  \|\   _ \  _   \|\   _ \  _   \|\  ___ \ |\   __  \    
\ \  \___|\ \  \|\  \ \  \|\  \ \  \\\__\ \  \ \  \\\__\ \  \ \   __/|\ \  \|\  \   
 \ \_____  \ \   ____\ \   __  \ \  \\|__| \  \ \  \\|__| \  \ \  \_|/_\ \   _  _\  
  \|____|\  \ \  \___|\ \  \ \  \ \  \    \ \  \ \  \    \ \  \ \  \_|\ \ \  \\  \| 
    ____\_\  \ \__\    \ \__\ \__\ \__\    \ \__\ \__\    \ \__\ \_______\ \__\\ _\ 
   ...
   \|_________|                                                                     
        ...
        self.message = "@everyone GET NUKED BY FSOCIETY "
    ...
    def display_menu(self):
        ...
        print("\n")
        print(Colorate.Horizontal(Colors.purple_to_blue, Center.XCenter("fuck the nigger server with channels Developed by FPERCENT")))
        print("\n")
    ...
    def get_inputs(self):
        ...
        self.display_menu()
        spam_concurrency_prompt = Colorate.Horizontal(Colors.purple_to_blue,
