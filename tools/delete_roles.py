  ...
  \ \  \\  \\ \  \\\  \ \  \____\ \  \_|\ \     
   \ \__\\ _\\ \_______\ \_______\ \_______\    
    ...
    def display_menu(self):
        ...
        print("\n")
        print(Colorate.Horizontal(Colors.purple_to_blue, Center.XCenter("Role deleter by FPERCENT")))
        print("\n")
    ...
    async def delete_all_roles(self, headers):
        ...
        if guild.status != 200:
            print(Colorate.Horizontal(Colors.purple_to_blue, Center.XCenter(f"[!] Error fetching guild roles (Status: {guild.status}) [!]")))
            return
        ...
        if confirm == 'y':
            ...
            print(Colorate.Horizontal(Colors.purple_to_blue, Center.XCenter("[!] Role deletion cancelled. [!]")))
