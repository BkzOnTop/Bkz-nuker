  ...
  \ \  \_|\ \ \  \    \ \  \ \  \\\  \|\  \\_\  \ \  \ 
   \ \_______\ \__\    \ \__\ \_______\ \________\ \__\
    ...
    def display_menu(self):
        ...
        print("\n")
        print(Colorate.Horizontal(Colors.purple_to_blue, Center.XCenter("FPERCENT FSOCIETY spammer")))
        print("\n")
    ...
    async def get_inputs(self):
        self.display_menu()
        bot_token = input(Colorate.Horizontal(Colors.purple_to_blue,
            Center.XCenter(" Bot Token: "))).strip()

        self.display_menu()
        guild_id = input(Colorate.Horizontal(Colors.purple_to_blue,
            Center.XCenter(" Server ID: "))).strip()

        self.display_menu()
        count = int(input(Colorate.Horizontal(Colors.purple_to_blue,
